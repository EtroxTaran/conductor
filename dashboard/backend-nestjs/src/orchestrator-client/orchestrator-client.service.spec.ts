  ...
  describe('Projects', () => {
    ...
    describe('initProject', () => {
      ...
      it('should handle project already exists error', async () => {
        mockFetch.mockResolvedValueOnce(
          createMockResponse(MockResponses.initProjectErrorResponse, false, 400),
        );
  ...
  describe('Chat', () => {
    describe('chat', () => {
      it('should send chat message', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            method: 'POST',
            body: JSON.stringify({ message: 'Hello', project_name: undefined, context: undefined }),
          }),
        );
      });
    ...
    describe('executeCommand', () => {
      ...
      it('should handle command error', async () => {
        ...
        await expect(
          service.executeCommand('/invalid'),
        ).rejects.toThrow();
      });
    });
  });
