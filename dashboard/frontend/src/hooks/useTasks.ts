...
export const taskKeys = {
  all: ['tasks'] as const,
  lists: (projectName: string) => [...taskKeys.all, 'list', projectName] as const,
  list: (projectName: string, status?: string) =>
    [...taskKeys.lists(projectName), { status }] as const,
  details: (projectName: string) => [...taskKeys.all, 'detail', projectName] as const,
 ...
 */
export function useTaskHistory(projectName: string, taskId: string, limit = 100) {
